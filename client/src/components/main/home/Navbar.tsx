...
const Navbar = () => {
  return (
    <div className="w-full  common-padding  max-w-7xl mx-auto grid grid-cols-2 items-center md:grid-cols-3 ">
        ...
        <Link to="/" className="hover:text-white   tracking-wider font-medium uppercase">
          <div className="flex gap-2 items-center">
            <div className="rounded-full overflow-hidden h-10 w-10 object-cover">
              <img src={'arena-x.png'} alt="arena-x" />
            </div>
            <div className="flex flex-col">
              <span className="text-sm sm:text-xl font-furore sm:first-letter:text-3xl tracking-widest">
                Arena
              </span>
            </div>
          </div>
      ...
      <div className="flex items-center justify-end md:gap-x-2">
        <ConnectToWallet />
        <NotificationBtn />
        <CustomButton
          title={'LOGIN'}
