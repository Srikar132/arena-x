import { ArrowUpRight, Clock, Medal, Coins, Scale, CreditCard, Shield } from 'lucide-react';
        ...
        <div className="flex flex-col ">
          ...
          <div className="grid mt-10 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {benefits.map((benefit, index) => (
              <BenefitCard key={index} {...benefit} onClick={() => handleGameClick(benefit.id)}/>
            ))}
          </div>
        </div>
      </div>
